...
async function testQueryMedium(tablaDePrueba: Table<pkDto, skDto, dataDto>) {
  ...
  const batch1 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  const batch2 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  const batch3 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  if (batch3.lastEvaluatedKey != batch3.firstEvaluatedKey) {
    throw new Error(
      'lastEvaluatedKey should be the same as firstEvaluatedKey in batch3'
    );
  }
  ...
  const batch4 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  const batch5 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  const batch6 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  const batch7 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  const batch8 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  if (batch8.lastEvaluatedKey != batch8.firstEvaluatedKey) {
    throw new Error(
      'lastEvaluatedKey should be the same as firstEvaluatedKey in batch8'
    );
  }
  ...
  const batch9 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  if (batch9.lastEvaluatedKey != batch9.firstEvaluatedKey) {
    throw new Error(
      'lastEvaluatedKey should be the same as firstEvaluatedKey in batch9'
    );
  }
  ...
  const batch10 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
  ...
  const batch11 = await tablaDePrueba
    .query({
      pk: { A: '2', B: 'b', C: 'c', D: 'd' },
      limit: 5,
    })
